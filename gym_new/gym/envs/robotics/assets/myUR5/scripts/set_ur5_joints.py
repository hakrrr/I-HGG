...
if __name__ == "__main__":
    ...
    model_file_path = "/home/matthias/snake-env/lib/python3.6/site-packages/gym/envs/robotics/assets/myUR5/include/robot_follow.xml" #input("Please type the path to the xml file to be updated: ")
